...
This document describes the LIF and its purpose. This document does not describe any logical processes that a fleet control system must implement to interpret the data contained in the LIF.
...
| *maximumSpeed* | m/s | float64 | Range: [0.0 ... integer.maximum]  Permitted maximum speed on the edge. Speed is defined by the fastest measurement of the mobile robot.  Note: If not defined, no limitation. <br><br>Backwards compatibility: for VDA 5050 2.1 or prior, use as *maxSpeed*. |
| *maximumRotationSpeed* | rad/s | float64 | Range: [0.0 ... integer.maximum]  Maximum rotation speed  Note: If not defined, no limitation. <br><br>Backwards compatibility: for VDA 5050 2.1 or prior, use as *maxRotationSpeed*. |
...
| *maximumMobileRobotHeight* | meter | float64 | Range: [0.0 ... integer.maximum]  Permitted maximum height of the mobile robot, including the load, on edge.  Note: If not defined, no limitation. <br><br>Backwards compatibility: for VDA 5050 2.1 or prior, use as *maxHeight*. |
...
| *aMinimum* | meter | float64 | Range: [0.0 ... integer.maximum]  Minimum length of the ellipse semi-major axis in meters. |
| *aMaximum* | meter | float64 | Range: [0.0 ... integer.maximum]  Maximum length of the ellipse semi-major axis in meters. |
| *bMinimum* | meter | float64 | Range: [0.0 ... integer.maximum]  Minimum length of the ellipse semi-minor axis in meters. |
| *bMaximum* | meter | float64 | Range: [0.0 ... integer.maximum]  Maximum length of the ellipse semi-minor axis in meters. |
...
| maximumLeftWidth | meter | float64 | Range: [0.0 ... integer.maximum]  Maximum corridor margin possible to the left of the edge. |
| maximumRightWidth | meter | float64 | Range: [0.0 ... integer.maximum]  Maximum corridor margin possible to the right of the edge. |
