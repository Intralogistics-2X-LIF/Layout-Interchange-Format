...
| *stationName* |  | string | Name of the station. Used to forward to the vehicle as part of the pick or drop action. |
| *stationType* |  | string | Type of the station. Used to forward to the vehicle as part of the pick or drop action. |
