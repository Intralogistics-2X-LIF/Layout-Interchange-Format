...
| *maximumSpeed* | m/s | float64 | Range: [0.0 ... float64.maximum]  Permitted maximum speed on the edge. Speed is defined by the fastest measurement of the mobile robot.  Note: If not defined, no limitation. <br><br>Backwards compatibility: for VDA 5050 2.1 or prior, use as *maxSpeed*. |
| *maximumRotationSpeed* | rad/s | float64 | Range: [0.0 ... float64.maximum]  Maximum rotation speed  Note: If not defined, no limitation. <br><br>Backwards compatibility: for VDA 5050 2.1 or prior, use as *maxRotationSpeed*. |
...
| *maximumMobileRobotHeight* | meter | float64 | Range: [0.0 ... float64.maximum]  Permitted maximum height of the mobile robot, including the load, on edge.  Note: If not defined, no limitation. <br><br>Backwards compatibility: for VDA 5050 2.1 or prior, use as *maxHeight*. |
